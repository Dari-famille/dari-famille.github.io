...
const SITUATIONS = [
...

  {
    ...
    kidLabel: "J'ai besoin de quelque chose",
    emoji: "🆘",
    audience: "both",
    free: true,
    intro:
    ...
    kidIntro: "Pour demander ce dont tu as besoin, tout seul.",
    lines: [
      {
        fr: "J'ai faim",
        latin: "Fiya jou3",
      ...
      },
      {
        ...
        arabic: "بغيت الما",
        kid: true,
        note: "La phrase la plus utile de toute l'app pour un jeune enfant.",
      },
      {
        fr: "J'ai mal ici",
        latin: "Kaydrni hna",
  ...
  {
    id: "ce-quon-te-dit",
    label: "Ce que votre enfant va entendre",
    kidLabel: "Ce que mamie va te dire",
    emoji: "👵",
    audience: "both",
    free: true,
    intro:
...

  {
    ...
    kidLabel: "Au téléphone avec papi et mamie",
    emoji: "📞",
    audience: "both",
    free: false,
    intro:
    ...
    lines: [
      ...
      },
      {
        ...
        note:
          ...
          "donnerait « kanbousek », qui sonne étrange à l'oreille marocaine. " +
          "(Transcription à confirmer : « bslama » ou « bseslama ».)",
      },
      {
        fr: "On vient bientôt",
      ...
      },
      {
        ...
        note:
          ...
          + "« dewwez », fais passer. Attention à ne pas confondre : « mmi » "
          + "est la grand-mère, « mama » est la mère.",
      },
    ],
  },
  ...
  {
    id: "questions-quon-vous-pose",
    label: "Les questions qu'on va vous poser",
    emoji: "❓",
    audience: "adult",
    free: false,
    intro:
      "Le pendant adulte de ce que votre enfant entendra. On vous posera ces " +
      "questions dès le premier repas, souvent plusieurs fois, et par des gens " +
      "différents. Les reconnaître suffit : personne n'attend une réponse " +
      "élaborée, on attend que vous ayez compris.",
    lines: [
      {
        fr: "Comment tu t'appelles ?",
        latin: "Chnou smitek ?",
        arabic: "شنو سميتك؟",
        note: "Répondez « smiti… » suivi de votre prénom.",
      },
      {
        fr: "Tu viens d'où ?",
